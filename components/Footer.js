      ...
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-cyan-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© Waleedghori —
            <a href="/home" className="text-cyan-600 ml-1" rel="noopener noreferrer" >@not available</a>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a className="ml-3 text-cyan-500" href='https://www.linkedin.com/in/waleed-ghori-810099216/' target='_blank'>
